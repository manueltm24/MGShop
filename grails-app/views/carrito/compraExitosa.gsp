                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-12 text-left">
                                <h2 class="title">Compra realizada!</h2>
                            </div><!-- end col -->
                        </div><!-- end row -->
                            ...
                            <div class="col-sm-12">
                                ...
                                <fieldset>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        <g:each in="${compra.products}" var="p" status="index">
                                ...
                                %{--<g:link action="generarDespachoPDF" params="[idCompra: compra.id]" controller="carrito" ><button type="button" class="btn btn-default round btn-md"><b>Descargar factura</b></button></g:link>--}%
